    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('terraform.enableLanguageServer', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (selected) {
                ...
                yield initCommand(client, moduleUri.toString());
            }
            ...
            if (vscode.window.activeTextEditor) {
                ...
                const modules = yield rootModules(client, documentUri.toString());
                let selectedModule;
                ...
                yield initCommand(client, selectedModule);
            }
...
function initCommand(languageClient, moduleUri) {
    return __awaiter(this, void 0, void 0, function* () {
        const requestParams = { command: `${languageClient.commandPrefix}.terraform-ls.terraform.init`, arguments: [`uri=${moduleUri}`] };
        return execWorkspaceCommand(languageClient.client, requestParams);
    });
}
function enabled() {
